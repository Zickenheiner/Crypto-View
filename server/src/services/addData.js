const data = {
  ...
  tokens: [
    ...
    },
    {
      ...
      decimals: 18,
      logoURI:
        "https://assets-cdn.trustwallet.com/blockchains/ethereum/assets/0x745407c86DF8DB893011912d3aB28e68B62E49B0/logo.png",
      pairs: [],
    },
    {
    ...
    },
    {
      ...
      decimals: 8,
      logoURI:
        "https://assets-cdn.trustwallet.com/blockchains/ethereum/assets/0xd1d2Eb1B1e90B638588728b4130137D262C87cae/logo.png",
      pairs: [],
    },
    {
    ...
    },
    {
      ...
      decimals: 18,
      logoURI:
        "https://assets-cdn.trustwallet.com/blockchains/ethereum/assets/0xB0c7a3Ba49C7a6EaBa6cD4a96C55a1391070Ac9A/logo.png",
      pairs: [],
    },
    {
      ...
      decimals: 18,
      logoURI:
        "https://assets-cdn.trustwallet.com/blockchains/ethereum/assets/0xCEBA2a8F6Ec221AEB5f3a7bcd15Cbc7e6a387bfb/logo.png",
      pairs: [],
    },
  ],
  version: {
...
(async () => {
  ...
  for (const token of tokens) {
    ...
    count++;
    try {
      const response = await fetch("http://localhost:3310/api/tokens", {
        method: "POST",
        headers: {
